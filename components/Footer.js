const withStyles = (icon) => (
  <div className="bg-gray-100 rounded-full p-1 hover:bg-gray-200">{icon}</div>
);
...
let githubIcon = (
  <svg width="30" height="30" viewBox="71 71 370 370">
...
linkedinIcon = withStyles(linkedinIcon);
githubIcon = withStyles(githubIcon);
